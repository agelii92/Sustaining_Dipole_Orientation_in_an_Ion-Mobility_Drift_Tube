...
os.system('/home/emiliano/SOFTWARE/gromacs-2019.3/local/gromacs/bin/gmx editconf -f oriented_T308K_noncenter.gro -c -o oriented_T308K.gro')
...
if N == '0':
        ...
        os.system('/home/emiliano/SOFTWARE/gromacs-2019.3/local/gromacs/bin/gmx insert-molecules -f oriented_T308K.gro -nmol '+N+' -ci 1ar.pdb -o 1ubq_'+N+'Ar_pre.gro')
...
#running the pre thing without field
#Enter the given field strenght in the .mdp files
#os.system('sed -i \'s/confield/'+E+'/g\' nvt_'+N+'Ar_'+T+'K_E'+E1+'.mdp')
